 ...
 * @author osman
 */
public class StringExchangeWithInversion extends LocalSearch {
                            ...
                            for (int i = 0; i < lambda; i++) { //Loop i3
                                ...
                                for (int j = 0; j < lambda; j++) { //Loop i4
                                    ...
                                    if (tripNo[t2] == tripNo[t4]) { //both strings belongs to the same tour
                                        ...
                                        timeok = (Cb[t1] + timeOft8t4String + Ca[t5] + c[t1 > n ? 0 : t1][t4] + c[t8][t5 > n ? 0 : t5]) <= L
                                                && (Ca[t3] + timeOft2t6String + Cb[t7] + c[t3 > n ? 0 : t3][t2] + c[t6][t7 > n ? 0 : t7]) <= L;
                                    }
                            ...
                            for (int i = 0; i < lambda; i++) { //Loop i3
                                ...
                                for (int j = 0; j < lambda; j++) { //Loop i4
                                    ...
                                    if (tripNo[t2] == tripNo[t4]) { //both strings belongs to the same tour
                                        ...
                                        timeok = (Cb[t5] + timeOft8t4String + Ca[t1] + c[t1 > n ? 0 : t1][t4] + c[t8][t5 > n ? 0 : t5]) <= L
                                                && (Ca[t7] + timeOft2t6String + Cb[t3] + c[t3 > n ? 0 : t3][t2] + c[t6][t7 > n ? 0 : t7]) <= L;
                                    }
                                    if (!timeok) {
                                        continue;
                                    }
